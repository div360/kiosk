            ...
            <div className="main">
                ...
                <div className="section">
                    ...
                    <div className="lower-box">
                        <button className="erase-btn" name="erase">Erase  <i class="fa-solid fa-eraser"></i></button>
                    </div>
                
                </div>
                <div className="lower-btn">
                    <button name="logout" className="logout-btn">Log Out</button>
                    <button name="proceed" className="proceed-btn">Proceed</button>
                </div>
            </div>
        </body>
        </>
